...
const Agreement = () => {
  ...
  if (!booking) {
    return (
      <Box sx={{ minHeight: '100vh', pt: '110px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {success ? (
          ...
          <>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              ...
              {/* Item Summary */}
              <Box sx={{ bgcolor: 'var(--bg-card)', borderRadius: '18px', border: '1px solid var(--line)', p: { xs: 3, md: 4 } }}>
                ...
                <Box sx={{ display: 'flex', gap: 3, alignItems: 'center' }}>
                  <Box sx={{ width: 80, height: 80, borderRadius: '12px', overflow: 'hidden', flexShrink: 0, bgcolor: 'var(--bg)' }}>
              ...
              <Box sx={{ bgcolor: 'var(--bg-card)', borderRadius: '18px', border: '1px solid var(--line)', p: { xs: 3, md: 4 } }}>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, p: 2, bgcolor: 'var(--bg)', borderRadius: '12px', border: '1px solid var(--line)' }}>
